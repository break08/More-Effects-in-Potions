...
public class MoreEffectsInPotionsModPotions {
	...
	public static final DeferredHolder<Potion, Potion> RESISTANT = REGISTRY.register("resistant", () -> new Potion(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1200, 0, false, true)));
	...
	public static final DeferredHolder<Potion, Potion> HEALTH_BOOST_POTION = REGISTRY.register("health_boost_potion", () -> new Potion(new MobEffectInstance(MobEffects.HEALTH_BOOST, 1800, 0, false, true)));
	...
	public static final DeferredHolder<Potion, Potion> CONDUIT_POWER_POTION = REGISTRY.register("conduit_power_potion", () -> new Potion(new MobEffectInstance(MobEffects.CONDUIT_POWER, 1800, 0, false, true)));
	public static final DeferredHolder<Potion, Potion> DOLPHIN_GRACE_POTION = REGISTRY.register("dolphin_grace_potion", () -> new Potion(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 1600, 0, false, true)));
