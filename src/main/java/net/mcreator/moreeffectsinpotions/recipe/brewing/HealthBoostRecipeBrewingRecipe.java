...
@EventBusSubscriber
public class HealthBoostRecipeBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new HealthBoostRecipeBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), MoreEffectsInPotionsModPotions.HEALTH_BOOST_POTION);
		}
