...
@EventBusSubscriber
public class DolphinsGraceRecipeBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new DolphinsGraceRecipeBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), MoreEffectsInPotionsModPotions.DOLPHIN_GRACE_POTION);
		}
